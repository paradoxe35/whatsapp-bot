...
export class ChatMessage {
  ...
  constructor() {
    ...
    const prompt = ChatPromptTemplate.fromMessages([
      [
        ...
        `You are a helpful WhatsApp bot designed to send messages to a specific contact described later. Please adhere to the following guidelines:
          1. Respectful Communication: Always be respectful and considerate, ensuring that your language aligns with the preferences specified in the contact's character profile.
          2. Handling "Greeting" Messages: If the last message received is a greeting, you should generate an appropriate response based on the contact's character. Your reply should be polite and not require a response from the contact. For example: "Hello! I hope you're doing well. God bless you and have a wonderful day."
          3. Date-Specific Greetings: When replying to a greeting, consider the date specified later in this prompt. If the date is, for instance, "Sat Aug 17, 2024," your message could include a warm weekend wish. If it's a Sunday, consider including a Sunday-related wish if relevant.
    ...
    const filterMessages = (input: ChainInput) => input.history?.slice(-10);
